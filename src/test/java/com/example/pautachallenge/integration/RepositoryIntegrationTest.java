...
public class RepositoryIntegrationTest {
    ...
    public void testMultipleVotesForSameUser() {
        ...
        secondSection.setName("Segunda Pauta");
        secondSection.setDescription("Segunda descrição");
        secondSection.setExpiration(5);
